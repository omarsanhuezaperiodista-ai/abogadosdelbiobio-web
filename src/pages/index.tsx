  ...
  return (
    <>
            ...
            <div className="row">
              ...
              <div className="col-lg-7">
                <div className="features-content-box features-content-box-two mb-50">
                  <div
                    className="section-title section-title-left mb-25 wow fadeInUp"
                    data-wow-delay=".2s"
                  >
                    <h2 style={{ marginTop: "20px" }}>Nuestros valores</h2>
                  </div>
                  <div className="features-item-list">
                    <div
                      className="features-item features-item-two d-flex wow fadeInUp"
                      data-wow-delay=".3s"
                    >
                      <div className="icon">
          ...
          <div className="row no-gutters service-wrapper-one">
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="service-item service-item-two text-center wow fadeInUp" data-wow-delay=".25s">
                <div
                  className="item-bg bg_cover"
                  style={{ backgroundImage: "url(/static/assets/images/features/features-1.jpg)" }}
                />
                <div className="icon">
                ...
                <div className="content">
                  ...
                  <p>
                    otorgamos asesoría tanto a empresas como a trabajadores y sindicatos en diversas
                    materias tales como despidos injustificados, despido indirecto, nulidad, cobro de
                    prestaciones, demandas de tutela laboral por vulneración de derechos fundamentales,
                    indemnizaciones, accidentes laborales, cobro de finiquitos entre otros.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div
                style={{ height: "100%" }}
                className="service-item service-item-two text-center wow fadeInUp"
                data-wow-delay=".30s"
              >
                <div
                  className="item-bg bg_cover"
                ...
                <div className="content">
                  <h4>DERECHO CIVIL</h4>
                  <p>
                    ofrecemos representación legal en causas civiles tales como herencias, posesiones
                    efectivas, juicios de arrendamiento, indemnización de perjuicios, juicios de
            ...
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="service-item service-item-two text-center wow fadeInUp" data-wow-delay=".35s">
                ...
                <div className="content">
                  ...
                  <p>
                    te representamos en causas de familia, donde contaras con abogados con magister en
                    derecho de familia a fin de otorgar una correcta asesoría y defensa legal en asuntos
                    tan importantes como las relaciones familiares en causas tales como demanda de
                    alimentos, rebaja y cese de pensión, divorcios, demanda de relación directa y regular,
                    compensación económica, denuncias por violencia intrafamiliar, causas de protección de
                    menores etc.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-6 col-md-6 col-sm-12">
              ...
              >
                ...
                <div className="content">
                  <h4>Derecho penal</h4>
                  <p>
                    ofrecemos representación jurídica en áreas del derecho penal, analizando y proponiendo
                    ideas claras desde un principio para solucionar tu problema lo antes posible, y siempre
                    actuando dentro del marco jurídico en la representación de estos procesos.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section style={{ marginTop: "100px" }} className="team-area">
        <div
          className="team-bg-wrapper bg_cover pt-200 pb-180"
          style={{ backgroundImage: "url(/static/assets/images/bg/team-bg-1.jpg)" }}
        >
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-8">
                <div
                  className="section-title text-center section-title-white mb-75 wow fadeInUp"
                  data-wow-delay=".2s"
                >
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 col-sm-12">
                <div className="team-item team-item-one mb-40 wow fadeInUp" data-wow-delay=".25s">
                  <div className="team-img">
                    ...
                    <div className="team-overlay">
                      <div className="button text-center mb-30 mt-30 wow fadeInUp" data-wow-delay=".50s">
                        <Link href="/agendarConsulta" className="main-btn">
                          Agendar
                        </Link>
                      </div>
                    </div>
                  ...
                  <div className="team-content">
                    <h3 className="title">
                      <Link href="/agendarConsulta">Laboral</Link>
                    </h3>
              ...
              <div className="col-lg-3 col-md-6 col-sm-12">
                <div className="team-item team-item-one mb-40 wow fadeInUp" data-wow-delay=".30s">
                  ...
                  <div className="team-content">
                    <h3 className="title">
                      <Link href="/agendarConsulta">Civil</Link>
                    </h3>
              ...
              <div className="col-lg-3 col-md-6 col-sm-12">
                <div className="team-item team-item-one mb-40 wow fadeInUp" data-wow-delay=".35s">
                  ...
                  <div className="team-content">
                    <h3 className="title">
                      <Link href="/agendarConsulta">Familia</Link>
                    </h3>
                    <span className="position">$30.000</span>
                  </div>
                </div>
              ...
              <div className="col-lg-3 col-md-6 col-sm-12">
                <div className="team-item team-item-one mb-40 wow fadeInUp" data-wow-delay=".40s">
                  ...
                  <div className="team-content">
                    <h3 className="title">
                      <Link href="/agendarConsulta">Penal</Link>
                    </h3>
              ...
              <div className="col-lg-6">
                <div className="about-content-box about-content-box-two wow fadeInLeft" data-wow-delay=".3s">
                  <div className="section-title section-title-left mb-25">
                    <h2 style={{ marginTop: "100px" }}>Metodología de trabajo</h2>
                  </div>
                  <p>
                    Nuestro estudio en primer lugar le otorga al usuario una reunión a fin de aclarar
                    consultas legales que tengas al momento de contratar con nosotros, si el caso reviste
                    de mayor complejidad se planifica una defensa y se da a conocer el presupuesto por los
                    servicios requeridos, aceptado se da inicio a las respectivas acciones legales
                    priorizando siempre la integridad de nuestro cliente.
                  </p>
                </div>
              </div>
              <div className="col-lg-6">
                <div
                  ...
                  data-wow-delay=".4s"
                  style={{ backgroundImage: "url(/static/assets/images/tribunales.webp)" }}
                />
              </div>
            </div>
          </div>
